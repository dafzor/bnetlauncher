...
namespace bnetlauncher
{
    public class ProcessCreator
    {
        ...
        public static bool CreateProcess(string command, int parentProcessId)
        {
            ...
            try
            {
                ...
                var lpApplicationName = command; //Path.Combine(Environment.SpecialFolder.ProgramFilesX86.ToString(), "Battle.net", "Battle.net.exe");
