...
There are still other launcher projects in active development like [Battlenet-Launcher](https://github.com/ShizCalev/Battlenet-Launcher) in case bnetlauncher no longer works for you.
